...
namespace temp1
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            string connectionString = (@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Khalawi\Source\Repos\GroupAssignment4\temp1\temp1\HappyTechDatabase.mdf;Integrated Security=True;Connect Timeout=30");
